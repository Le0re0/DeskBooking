        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookedFrom = table.Column<DateTime>(type: "TEXT", nullable: false),
                    BookedUntil = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EmployeeId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookedDesks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookedDesks_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookedDesks_EmployeeId",
                table: "BookedDesks",
                column: "EmployeeId");
